...
var styleSwitcher = {
    init: function () {
        ...
        // Style Switcher CSS
        yepnope([
            {load: '/media/css/style-switcher.css'},
            {load: '/media/lib/colorpicker/css/colorpicker.css'},
            {load: '/media/lib/cssbeautify/cssbeautify.js'},
            {load: '/media/lib/colorpicker/js/bootstrap-colorpicker.js',
                complete: function () {
                    yepnope([
                        {load: 'less!/media//less/theme.less'},
                        {load: '/media/lib/less-1.5.1.min.js',
                            complete: function () {
